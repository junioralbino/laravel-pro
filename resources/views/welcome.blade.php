    ...
    <div class="app-wrapper"> <!--begin::Header-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#"> <i
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#"
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="{{ Vite::asset('resources/imagens/user.jpg') }}"
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item">
                                <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="{{ Vite::asset('resources/imagens/user2.jpg')}}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                            data-bs-toggle="dropdown"> <img src="{{ Vite::asset('resources/imagens/user.jpg') }}"
                                class="user-image rounded-circle shadow" alt="User Image"> <span
                                class="d-none d-md-inline">Alexander Pierce</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> <img
                                    src="{{ Vite::asset('resources/imagens/user.jpg') }}" class="rounded-circle shadow"
                                    alt="User Image">
                                <p>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image--> <img src="{{ Vite::asset('resources/imagens/AdminLTELogo.png')}}" alt="AdminLTE Logo"
                                    ...
                                    <div class="direct-chat-messages"> <!-- Message. Default to the start -->
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix"> <span
                                                ...
                                                class="direct-chat-img" src="{{ Vite::asset('resources/imagens/user.jpg')}}"
                                        ...
                                        <div class="direct-chat-msg end">
                                            <div class="direct-chat-infos clearfix"> <span
                                                ...
                                                class="direct-chat-img" src="{{ Vite::asset('resources/imagens/user2.jpg')}}"
                                                alt="message user image"> <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
